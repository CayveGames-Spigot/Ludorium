...
public class HexColors {
	...
	private static final String[] rainbow = { "#f07e1f", "#e29910", "#b9ca01", "#a0dd02", "#85ed09", "#50fb27",
			"#38fa3c", "#24f255", "#07d48a", "#01bfa5", "#01a6be", "#078bd3", "#1271e5", "#2356f2", "#373dfa",
			"#6916f7", "#840aed", "#b901cb", "#cf05b4", "#e10f9a", "#f01f7f", "#f83264", "#fb494a", "#f96332" };
	...
	private static String Gradient(String color1, String color2, float weight) {
		try {
			...
			return String.format("#%02x%02x%02x", gradient.getRed(), gradient.getGreen(), gradient.getBlue());
		} catch (Exception e) {
			return "#FFFFFF";
		}
	}
